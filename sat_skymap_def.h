 ...
 *
 *  LN @ INAF-OAS, Feb 2020                      Last change: 10/04/2020
 *
 */
...
const char *progname = "sat_skymap", *progauthor = "L. Nicastro @ INAF-OAS", *progdate = "2020-04-10", *progversion = "0.1d";
...
double lst_hr(const double jd, double lon);
